...
const handleClickRight = (e: Event, val: IStep[]) => {
    let temp: IStep[] = JSON.parse(JSON.stringify(val))
            ...
            <div class="step-content">
                ...
                <div class="step-info">
                    ...
                    <div v-if="data.type === '判断时间'">
                        <span class="info-dot">{{ data.options.presses }}</span>
                        <span class="info-dot">{{ data.options.day }}</span>
                    </div>

                    <div v-if="data.type === '点击图片'">
                        鼠标
                        <span class="info-dot">{{ data.options.button }}</span>
                        <span class="info-dot">{{ data.options.clicks }}</span>
                        坐标偏移:
                        <span class="info-dot">x:{{ data.options.x }} , y:{{ data.options.y }}</span>
                    </div>
